...
--select * from department
 ...
 and user_new.name = 'abcd' and experience.currentValue=   ;
...
inner join profile on user_new.profile_id = profile.id
inner join experience on user_new.id = experience.id
where role.name = 'guide' and experience.currentValue=   
...
inner join profile on user_new.profile_id = profile.id
inner join experience on user_new.id = experience.id
where role.name = 'Alumini' and experience.currentValue=    and profile.batch='            '
order by user_new.name;
...
inner join profile on user_new.profile_id = profile.id
inner join experience on user_new.id = experience.id
where role.name='Alumni' and experience.currentValue=    and experience.company_name='TCS'
order by user_new.name;
